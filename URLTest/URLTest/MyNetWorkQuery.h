...
+ (void)requestData:(NSString *)urlString HTTPMethod:(NSString *)method  params:(NSMutableDictionary *)params completionHandle:(void(^)(id result, NSInteger responseCode))completionblock errorHandle:(void(^)(NSError *error))errorblock;

//封装使用AFNetWorking来申请JSON数据
